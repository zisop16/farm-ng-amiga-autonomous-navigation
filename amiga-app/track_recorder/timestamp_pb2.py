...
_TIMESTAMP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='stamp', full_name='Timestamp.stamp', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='clock_name', full_name='Timestamp.clock_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='semantics', full_name='Timestamp.semantics', index=2,
