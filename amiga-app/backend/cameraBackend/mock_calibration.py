...
intrinsic_mat = np.array([
    [2.82846289e+03, 0.00000000e+00, 1.92205481e+03],
    [0.00000000e+00, 2.82721777e+03, 1.14587720e+03],
...
rot_mat_2 = np.array([[1, 0, 0],  # Rotation by 180° around Y-axis to face Camera 1
                      [0, -1, 0],
                      [0, 0, -1]], dtype=np.float32)
trans_vec_2 = np.array([0.0, 0.0, 0.908])  # Camera 2 is offset
...
world_to_cam_1 = np.vstack((np.hstack((rot_mat_1, trans_vec_1.reshape(-1, 1))), np.array([0, 0, 0, 1])))
cam_to_world_1 = np.linalg.inv(world_to_cam_1)

# Camera 2 extrinsics (world-to-camera transformation)
world_to_cam_2 = np.vstack((np.hstack((rot_mat_2, trans_vec_2.reshape(-1, 1))), np.array([0, 0, 0, 1])))
